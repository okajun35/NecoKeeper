...
from app.auth.permissions import PERMISSIONS, has_permission, require_permission, require_role
...
class TestPermissionsMatrix:
    ...
    def test_all_roles_have_volunteer_read_permission(self):
        ...
        for role in roles:
            ...
            assert has_permission(user, "volunteer:read"), f"{role} should have volunteer:read"
...
class TestPermissionsMatrixCompleteness:
    ...
    def test_read_only_has_only_read_permissions(self):
        ...
        for permission in read_only_permissions:
            assert ":read" in permission, f"read_only has non-read permission: {permission}"
